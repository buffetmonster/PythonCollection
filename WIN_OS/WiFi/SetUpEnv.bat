...
pip3 list
ECHO Info for setup of startup macro: go_virtualenv
type ..\WindowsProfileSetup.txt
ECHO alternatively Env setup, call .\venv\Scripts\activate to activate
rem CALL python.exe .\qt5_PomodoroTimer.py
